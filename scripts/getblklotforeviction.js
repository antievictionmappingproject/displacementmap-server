...
dbQuery("select omi_address_temp.petition, address_orig, zipcode from omi_address_temp, omi_evictions where omi_address_temp.petition = omi_evictions.petition", 
	[],
